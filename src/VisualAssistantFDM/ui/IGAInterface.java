...
CreateNewPopulationButton.addActionListener(new java.awt.event.ActionListener() {
    ...
    private void CreateNewPopulationButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateNewPopulationButtonActionPerformed
                ...
                try {
                    initilisationBackground(individuSelect);
    ...
    /* méthode pour ajuster la probabilité de mutation */
    private void MutationSizeStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_MutationSizeStateChanged
        ...
        System.out.println("Mutate probability value : "+PminMute);
    }//GEN-LAST:event_MutationSizeStateChanged
    
    /* méthode pour ajuster le bruit ajouté à la valeur de chaque gène muté */
    private void WeightSizeStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_WeightSizeStateChanged
        ...
        System.out.println("additional noise Value : "+ALPHA);
    ...
    private void initilisationBackground(boolean selectIndivi[]){
        if(!CheckBox1.isSelected()){
        panel1.setBackground(new Color(240, 240, 240));
        } else{
        panel1.setBackground(Color.GREEN);    
    ...
    private boolean isState(boolean[] individuSelect) {
    ...
    private List<Integer> TirageAleatoire(int individu) throws Exception{
    ...
    private List<Visualisation> CreateInitialIndividual(List<Appariement> MECResultat) throws Exception{
    ...
    private List<Visualisation> CreateDataAttributeList(List<Appariement> MECResultat) throws Exception{
        List<Visualisation> population = new ArrayList<Visualisation>();
        for(int i=0; i<MECResultat.size(); i++){
           Visualisation visu = new Visualisation();
           visu.setName(MECResultat.get(i).getName_data());
    ...
    private List<Visualisation> CreateDataAttributeInitialList(List<Visualisation> MECResultat) throws Exception{
        List<Visualisation> population = new ArrayList<Visualisation>();
        for(int i=0; i<MECResultat.size(); i++){
           Visualisation visu = new Visualisation();
    ...
    private List<List<Visualisation>> clonePopulation(List<List<Visualisation>> MECResultat) throws Exception{
    ...
    private List<Visualisation> cloneIndividual(List<Visualisation> MECResultat) throws Exception{
    ...
    private List<Normalisation> cloneNormalisationVector(List<Normalisation> listNormamlisation) throws Exception{
    ...
    private List<Visualisation> CreateVisualAttributeList(List<Appariement> MECResultat) throws Exception{
        List<Visualisation> population = new ArrayList<Visualisation>();
        for(int i=0; i<MECResultat.size(); i++){
           Visualisation visu = new Visualisation();
    ...
    private List<Visualisation> FillingIntialIndividual(List<Visualisation> OldInitialIndividual, List<Visualisation> Choosen_Individual_Value) throws Exception{
    ...
    private List<List<Appariement>> GenererInitialPopulation(List<Visualisation> DataAttributeChromosome, List<Visualisation> visualAttributeChromosome) throws Exception {
...
//            Nouvelle_Population.add(filsMEC);
    ...
    private double MutationOperator(int OldValue){
    ...
    private int NON_UniformMutation_Operator(int OldValue){
    ...
    private List<MEC> getNewMatching(List<Visualisation> newMatch){
    ...
    private List<Appariement> getNewMatchingResult(List<Visualisation> DataAttribute, List<Visualisation> VisualDataAttribute) throws Exception{
    ...
    private DefaultTableModel Affichage(DefaultTableModel individu, List<Appariement> Matching, List<Visualisation> chromosomes) throws Exception{
    ...
    private void IndividuSelectInitialisation(){
    ...
    private boolean[] getIndividuSelect(boolean [] indSelect) {
    ...
    private List<List<Visualisation>> GetSelectedIndividus(boolean [] individuSelect){
    ...
    private void CrossOver(List<List<Visualisation>> Newpop) throws Exception{
    ...
    private List<List<Visualisation>> Mutation(List<List<Visualisation>> pop, boolean[] SelectIndividuals ) throws Exception{
    ...
    private List<List<Visualisation>> CrossOverOnePoint (List<Visualisation> chromosome1, List<Visualisation> chromosome2) {
    ...
    private List<List<Visualisation>> CrossOverUx (List<Visualisation> chromosome1, List<Visualisation> chromosome2) {
...
//               System.out.println("ZMax : "+MaxValue);
    ...
    public List<Visualisation> GenererNewDataAttributeIndividual(List<Visualisation> DataAttrbuteChromosome) throws Exception {
        ...
        for(int i=0; i<DataAttrbuteChromosome.size(); i++){
                ...
                if(i == random){
                int NewValue = (int) ((DataAttrbuteChromosome.get(i).getImportance()) * (Pmut));
                newInd.setImportance(NewValue);
                }
                else{
...
//    }
    ...
    public ArrayList getProfilArrayList(String profilSelected) {
        ArrayList profilList = new ArrayList();
